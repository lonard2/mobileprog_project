...
public class Movie {
    ...
    public Movie(Boolean adult, String backdropPath, Object belongsToCollection,
                 Integer budget, List<MovieGenre> genres, String homepage, Integer id,
                 String imdbId, String originalLanguage, String originalTitle,
                 String overview, Double popularity, Object posterPath,
                 ...
                 List<MovieSpokenLanguage> spokenLanguages, String status,
                 String tagline, String title, Boolean video, Double voteAverage,
                 Integer voteCount) {
        this.adult = adult;
